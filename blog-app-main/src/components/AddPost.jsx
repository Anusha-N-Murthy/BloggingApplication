...
const AddPost1 = () => {
    console.log("In AddPost.jsx => AddPost!!");
    ...
    useEffect(
        () => {
            console.log("In AddPost.jsx => AddPost.useEffect!!");
            console.log("In AddPost.jsx => AddPost.useEffect!! getCurrentUserDetail = "+getCurrentUserDetail());
            setUser(getCurrentUserDetail())
            console.log("In AddPost.jsx => AddPost.useEffect!! loadAllCategories = "+loadAllCategories());
            loadAllCategories().then((data) => {
                console.log("In AddPost.jsx => AddPost.useEffect!! loadAllCategories data = "+data);
                console.log(data)
                setCategories(data)
            }).catch(error => {
                console.log(error)
    ...
    const fieldChanged = (event) => {
        // console.log(event)
        console.log("In AddPost.jsx => fieldChanged!!");
